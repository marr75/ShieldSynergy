...
sealed class Configuration {
    ...
    public Configuration(ConfigFile c) {
        const string enabledDescription =
            "Turns the stacking bonus on or off. Off = shields work exactly like unmodified Solar "
        ...
        const string stackingCurveStrengthDescription =
            "How much extra reward you get for stacking shields together. 1.0 = vanilla (no bonus, "
        ...
        const string stackingBonusCapDescription =
            "Optional safety ceiling on the stacking bonus, so a big shield cluster combined with a "
